...
| node.gke.deployAllowList            | (optional) WorkloadAllowlist for the sensor daemonset when using GKE AutoPilot.                                                           |
| node.gke.cleanupAllowList           | (optional) WorkloadAllowlist for the cleanup daemonset when using GKE AutoPilot.                                                          |

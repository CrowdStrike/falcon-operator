...
| admissionConfig.tolerations               | (optional) Specify tolerations for scheduling the Falcon Admission Controller pods. See https://kubernetes.io/docs/concepts/scheduling-eviction/taint-and-toleration/ for examples on configuring tolerations. |

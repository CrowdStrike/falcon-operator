...
func (r *FalconContainerReconciler) reconcileImageStream(ctx context.Context, falconContainer *v1alpha1.FalconContainer) (*imagev1.ImageStream, error) {
	...
	if err != nil {
		if errors.IsNotFound(err) {
			...
			return imageStream, r.Create(ctx, falconContainer, imageStream)
		}
	...
	return existingImageStream, r.Update(ctx, falconContainer, existingImageStream)
